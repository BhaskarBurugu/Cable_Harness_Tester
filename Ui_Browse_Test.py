...
class Ui_Dialog_BrowseTest(object):
    def setupUi(self, Dialog_BrowseTest):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(70, 10, 1011, 51))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(190, 740, 791, 51))
    ...
    def retranslateUi(self, Dialog_BrowseTest):
        ...
        self.pushButton_Back.setText(_translate("Dialog_BrowseTest", "&Close"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    Dialog_BrowseTest = QtWidgets.QDialog()
    ui = Ui_Dialog_BrowseTest()
    ui.setupUi(Dialog_BrowseTest)
    Dialog_BrowseTest.show()
    sys.exit(app.exec_())
